-- Corrigir baixa de estoque após separação
-- O tipo 'saida_separacao' não deve baixar estoque imediatamente
-- Apenas 'saida_venda' (criada na conferência) deve baixar o estoque

-- Atualizar função create_inventory_movement para que saida_separacao não baixe estoque
...
-- Atualizar função calculate_stock_balance_before para considerar saida_separacao
-- saida_separacao não deve ser considerada no cálculo de saldo (não baixa estoque)
...
-- Atualizar função update_movement_balances para considerar saida_separacao
