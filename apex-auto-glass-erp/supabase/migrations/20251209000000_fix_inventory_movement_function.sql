-- ============================================
-- CORREÇÃO: Função create_inventory_movement
-- ============================================
-- Corrige:
-- 1. Problema de sobrecarga (múltiplas versões da função)
-- 2. Adiciona suporte para entrada_devolucao_cliente
-- 3. Garante que todos os tipos de movimentação sejam aceitos
-- ============================================

-- Primeiro, remover todas as versões existentes da função
DROP FUNCTION IF EXISTS public.create_inventory_movement(UUID, UUID, TEXT, INTEGER, TEXT, UUID, TEXT, UUID);
DROP FUNCTION IF EXISTS public.create_inventory_movement(UUID, UUID, TEXT, INTEGER, TEXT, UUID, TEXT, UUID, DECIMAL, TEXT, TEXT, DATE, TEXT);

-- Criar uma única versão da função com todos os parâmetros opcionais
...
-- Atualizar função calculate_stock_balance_before para incluir entrada_devolucao_cliente
...
-- Atualizar função update_movement_balances para incluir entrada_devolucao_cliente
